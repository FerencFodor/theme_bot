        ...
        switch (_a.label) {
          case 0:
            ...
            this._client.once("ready", function () {
              return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, this._client.clearSlashes()];
                    case 1:
                      _a.sent();
                      return [
                        4 /*yield*/,
                        this._client.clearSlashes("851872708781146154"),
                      ];
                    case 2:
                      _a.sent();
                      return [
                        4 /*yield*/,
                        this._client.clearSlashes("741533650176442370"),
                      ];
                    case 3:
                      _a.sent();
            ...
            this._client.on("interaction", function (interaction) {
              _this._client.executeSlash(interaction).catch(function (err) {
